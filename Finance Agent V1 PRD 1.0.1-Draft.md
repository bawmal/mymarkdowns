...
## **2.1 Deterministic Forecasting With Probabilistic Inputs and Confidence Scoring**
...
- The **deterministic formula** is the calculation engine. It is
  > arithmetic. It always produces the same result from the same inputs.
  > It does not guess. It does not infer.

- The **probabilistic inputs** are the data the formula operates on.
  > Some inputs, like a verified bank balance are known with certainty.
  > Others, like whether a specific invoice will be paid on its due date
  > are estimated using probability weighting based on history and
  > aging.
...
Confidence is expressed as a percentage from 0–100%. Confidence
thresholds in this section are the canonical source of truth for
forecast, risk, recommendation, diagnostic, and interaction behaviour.

Thresholds:

50% and above: Outputs are usable with qualification. The Finance Agent
may present projections, risks, recommendations, and informational
insights, while continuing to identify high-impact missing information
when improving confidence would materially change forecast
interpretation, risk detection, or recommendation eligibility.
...
Below 30%: Outputs are suppressed by default. The Finance Agent does not
proactively present projections, recommendations, or informational
insights. Instead, it explains what information is missing, what
uncertainty remains, and what would improve confidence.
...
>
> · Risk-linked recommendation framework for invoice collection,
> deferral, and credit access information, sequenced after core risk
> detection
>
> · Onboarding with PSP configuration and merchant progressive
> profiling.
>
...
>
> · Headless API for PSP-built frontends including agent access and
> usage metadata.
...
> the fallback.
>
> · Operating costs detection through pattern recognition: recurring
> costs can be entered manually.
>
...
> explain what is driving it, and show whether it appears durable after
> known obligations and forecast uncertainty. Surplus outputs remain
> informational in V1 and do not override active or emerging risk
> alerts.
...
## **5.5 Must Have, Should Have, Future, Assumption**
...
>
> · **Should Have:** Important for V1. Can be deferred to a fast follow
> if critical path requires it.
>
> · **Future Consideration:** Deliberate V2 or V3 capability. Not
> expected in V1 scope.
>
...
<tr class="odd">
<th>PSP/Acquirer settlement account feed</th>
<th>External (required)</th>
<th>Minimum required data source for V1</th>
</tr>
<tr class="header">
<th>Open banking API</th>
<th>External (optional)</th>
<th>PSP-enabled and market-dependent</th>
</tr>
<tr class="odd">
<th>PSP/Acquirer fee and reserve rate configuration</th>
<th>Config<br />
(required)</th>
<th>Must be set before net balance can be calculated</th>
</tr>
</thead>
<tbody>
</tbody>
...
<tr class="odd">
<th>Trigger</th>
<th>T-DC-01: New transaction batch. T-DC-02: New invoice. T-DC-03:
...
<p>Holiday calendar from market configuration.</p></th>
</tr>
<tr class="odd">
<th>Decision Logic</th>
<th><p>Net revenue equals gross minus refunds minus chargebacks.</p>
...
bias applied to revenue projection.</p></th>
</tr>
<tr class="header">
<th>Human Gate</th>
<th>When a new recurring pattern is detected that has not been
...
presented for individual confirmation before use.</th>
</tr>
<tr class="odd">
<th>Failure Modes</th>
<th><p>Settlement schedule not configured: default to T+2 with reduced
...
<tr class="odd">
<th>PSP transaction feed</th>
<th>External<br />
(required)</th>
<th>Core inflow data source</th>
</tr>
<tr class="header">
<th>PSP settlement schedule</th>
<th>Config<br />
(required)</th>
<th>Must be configured by PSP before settlement timing operates</th>
</tr>
<tr class="odd">
<th>Accounting platform or manual entry</th>
<th>External (optional)</th>
<th>Required for AR tracking. Forecast operates without it at lower
confidence.</th>
</tr>
<tr class="header">
...
<th>Config<br />
(required)</th>
<th>Set by PSP based on market. Affects settlement date
calculations.</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<th>Trigger</th>
<th>T-DC-04: New expense or bill entered. T-TB-01 and T-TB-02: Payroll
...
<tr class="header">
<th>Inputs</th>
<th><p>Payroll platform data or manual entry.</p>
<p>Accounting platform payable records or manual entry.</p>
<p>Tax obligation schedule from jurisdiction configuration.</p>
<p>Pattern detection outputs for recurring costs.</p></th>
</tr>
<tr class="odd">
<th>Decision Logic</th>
<th><p>Payroll and tax are always hard constraints.</p>
...
with appropriate confidence.</p></th>
</tr>
<tr class="header">
<th>Human Gate</th>
<th>When a recurring expense pattern is first detected, ask the merchant
to confirm before including in calendar. When payroll data has not been
connected by day 3, ask for manual payroll details.</th>
</tr>
<tr class="odd">
<th>Failure Modes</th>
<th>No payroll data after prompt: payroll excluded from forecast with
...
<tr class="odd">
<th>Payroll platform connection or manual entry</th>
<th>External (optional)</th>
<th>Required for payroll shortfall detection. System prompts from day
1.</th>
</tr>
<tr class="header">
<th>Accounting platform or manual entry</th>
<th>External<br />
(optional)</th>
<th>Required for full AP tracking</th>
</tr>
<tr class="odd">
<th>Tax jurisdiction configuration</th>
<th>Config (required)</th>
<th>Set by merchant or PSP based on business location</th>
</tr>
</thead>
<tbody>
</tbody>
...
<tr class="odd">
<th>Trigger</th>
<th>T-DC-01 through T-DC-07: Any material data change. T-TB-06: Daily
scheduled refresh. T-UA-02: Merchant answers question. T-UA-04: Merchant
enters manual data.</th>
</tr>
<tr class="header">
<th>Inputs</th>
<th>Unified financial state from Orchestrator. Cash buffer floor from
merchant configuration. Historical revenue data for trend and
projection.</th>
</tr>
<tr class="odd">
<th>Decision Logic</th>
<th><p>Apply cash flow formula day by day.<br />
...
Conservative bias applied throughout.</p></th>
</tr>
<tr class="header">
<th>Human Gate</th>
<th>When forecast confidence is below 50% for the first seven days, the
Interaction Layer surfaces a specific explanation and asks what data the
merchant can provide to improve confidence.</th>
</tr>
<tr class="odd">
<th>Failure Modes</th>
<th>No balance data: forecast cannot run. Message explains the
...
revenue and payroll data. System asks for them.</th>
</tr>
</thead>
<tbody>
</tbody>
...
<tr class="odd">
<th>Unified financial state from Orchestrator</th>
<th>Internal (required)</th>
<th>Forecast Agent cannot run without this</th>
</tr>
<tr class="header">
<th>Cash buffer floor</th>
<th>Config (Merchant)</th>
<th>Defaults to zero if not set. Merchant prompted to set it during
onboarding.</th>
</tr>
<tr class="odd">
<th>Minimum confidence threshold</th>
<th>Config<br />
(System default)</th>
<th>Can be adjusted by PSP</th>
</tr>
</thead>
<tbody>
</tbody>
...
<tr class="odd">
<th>Forecast Agent output</th>
<th>Internal (required)</th>
<th>Risk Agent cannot operate without a current forecast</th>
</tr>
<tr class="header">
<th>Cash buffer floor</th>
<th>Config<br />
(Merchant)</th>
<th>Risk thresholds calibrated against this value</th>
</tr>
<tr class="odd">
<th>Alert threshold configuration</th>
<th>Config (PSP)</th>
<th>Day thresholds for severity classification</th>
</tr>
</thead>
<tbody>
</tbody>
...
<tr class="odd">
<th>Risk Agent output</th>
<th>Internal<br />
(required)</th>
<th>Recommendation Agent triggered by Risk Agent routing</th>
</tr>
<tr class="header">
<th>PSP credit product configuration</th>
<th>Config (required for credit recommendations)</th>
<th>If not configured, credit recommendations are unavailable</th>
</tr>
<tr class="odd">
<th>AR data</th>
<th>External (optional)</th>
<th>Required for collection recommendations</th>
</tr>
<tr class="header">
<th>AP data</th>
<th>External (optional)</th>
<th>Required for deferral options</th>
</tr>
</thead>
<tbody>
</tbody>
...
<tr class="odd">
<th>PSP configuration (all settings)</th>
<th>Config (required)</th>
<th>PSP onboarding must be complete before any merchant sees the
product</th>
</tr>
<tr class="header">
<th>PSP transaction feed</th>
<th>External<br />
(required)</th>
<th>First-session financial picture requires this</th>
</tr>
<tr class="odd">
<th>Accounting platform integrations</th>
<th>Config<br />
(PSP enables)</th>
<th>Xero and QuickBooks supported in V1</th>
</tr>
<tr class="header">
<th>Open banking integration</th>
<th>Config<br />
(PSP enables)</th>
<th>Market-dependent. PSP must enable before merchants can use it.</th>
</tr>
</thead>
<tbody>
</tbody>
...
figures used in alerts, recommendations, and explanations.

**Dates:** Always shown in both relative ("in 6 days") and absolute
("Thursday, March 14") form in alerts. Relative-only is acceptable in
...
>
> · It does not recommend hiring decisions, pricing changes, or
> strategic moves.
>
...
> surplus cash in V1. Surplus is in scope as financial intelligence, not
> as advice
...
**Every Forecast references the State version it was produced from.
Every Risk references the Forecast version. Every Recommendation
references the Risk. Every Alert references the Risk and Recommendations
it surfaces. Every Signal carries source attribution back to the worker
and the raw data event.
...
SECTION 13: NON-FUNCTIONAL REQUIREMENTS **13.1 Performance**

> · First-session financial picture renders within 3 seconds of
> authenticated session start, assuming PSP transaction feed is current.
>
> · Daily forecast refresh completes within 5 minutes of the scheduled
> trigger for any merchant with up to 18 months of transaction history.
>
> · Trigger detection latency: event-driven triggers fire within 30
> seconds of the underlying event for 95% of cases, within 2 minutes for
> 99%.
>
...
> · Raw merchant data must not leave the deployment region without
> passing through the privacy filter at the Orchestrator boundary. This
> is enforced architecturally, no service outside the deployment region
> has direct access to raw signal data.
>
> · LLM provider boundary: prompts sent to the configured LLM provider
> contain only the structured, redacted output of capability agents. Raw
> transaction data, counterparty names, and identifiable signals are not
> transmitted unless the PSP has explicitly configured a provider with
> the appropriate data processing agreement and the merchant has been
> notified.
>
> · Authentication: integration with PSP identity provider via OIDC or
> SAML. The Finance Agent does not maintain its own credential store for
> merchants.
>
...
> conversation history, and merchant context within 30 days of request.
>
...
>
> · Audit log: all system actions retained for 7 years minimum,
> immutable, exportable to PSP for compliance review.
...
> history.
>
> · System health dashboard tracking trigger latency, agent response
> time, worker success rates, and LLM provider availability.
...
> ● "Unlock growth."
>
> ● Any congratulation for routine events. ("Great job paying your
> bill!" — never.)
>
...
**The following outputs are directional. They require qualitative
testing with target merchants before being finalised.
